...
public class MainActivity extends AppCompatActivity {
    ...
    String b1, b2, b3, b4, b5, b6,b7, b8, b9, btnNew;
    int flag = 0;
    int count = 0;
    ...
    public void check(View view){
        ...
        if (btncurr.getText().toString().equals("")) {
            ...
            btnNew = btnNewGame.getText().toString();

            if (btncurr.getText().toString().equals(btnNew)){
                newGame();
            }
                ...
                if (b1.equals(b2) && b2.equals(b3) && !b1.equals("")) {
                    ...
                    //2
                    Toast.makeText(this, "Winner is : " + b1, Toast.LENGTH_SHORT).show();newGame();
                } else if (b4.equals(b5) && b4.equals(b6) && !b4.equals("")) {
                    //3
                    Toast.makeText(this, "Winner is : " + b4, Toast.LENGTH_SHORT).show();newGame();
                } else if (b7.equals(b8) && b7.equals(b9) && !b7.equals("")) {
                    //4
                    Toast.makeText(this, "Winner is : " + b7, Toast.LENGTH_SHORT).show();newGame();
                } else if (b2.equals(b5) && b2.equals(b8) && !b2.equals("")) {
                    //5
                    Toast.makeText(this, "Winner is : " + b2, Toast.LENGTH_SHORT).show();newGame();
                } else if (b3.equals(b6) && b3.equals(b9) && !b3.equals("")) {
                    //6
                    Toast.makeText(this, "Winner is : " + b3, Toast.LENGTH_SHORT).show();newGame();
